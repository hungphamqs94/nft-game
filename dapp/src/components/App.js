...
class App extends Component {
  ...
  componentDidMount(){
    console.log('khong chiu mo luon')
  ...
  setWeb3(web3) {
    console.log('co vao day ko:'+web3);
    this.setState({web3});
  }
  ...
  handleOpenLoadingCoin = e => {
    console.log('khong handle duoc a', e)
    this.setState({
      isLoadingCoinLoading: true,
    });
  }
      ...
      <div className="App">
        <div className="index">
          <div className="titlebox">
            ...
            {/* { isLoading && <Loading/> } */}
            <a className="gameplay" onClick={this.handleGoArena}></a>
            <a className="getCard" onClick={this.gotoAndPlayGame}></a>
