  ...
  handlePlaceBet = async e => {
    ...
    web3.eth.sendTransaction(tx, (err, response) => {
      ...
      let t = setInterval(async () => {
        const result = await axios.get(`https://api-ropsten.etherscan.io/api?module=transaction&action=gettxreceiptstatus&txhash=${response}&apikey=ZG8RGUNZJPGDEKEY5K4ZQIKSM7AF6I15CB`)
