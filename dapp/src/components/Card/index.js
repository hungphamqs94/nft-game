...
class Card extends Component {
  ...
  componentDidMount() {
    ...
    console.log('gia tri cua network,', network)
  }
  ...
  handleMetaMaskCallBack = (err, result)=>{
    ...
    let t = setInterval(async ()=>{
      const result = await axios.get(`https://api-ropsten.etherscan.io/api?module=transaction&action=gettxreceiptstatus&txhash=${tx}&apikey=ZG8RGUNZJPGDEKEY5K4ZQIKSM7AF6I15CB`);
